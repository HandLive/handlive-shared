...
JSON Schema draft 2020-12 cho khung tin thiết bị ↔ thiết bị, sinh từ `docs/detailed-design/00-common-specs.md` (0.3, 0.5.1, 0.6.3, 0.7.1, 0.7.2, 0.8.1, 0.8.3) và đặc tả chi tiết CONN-01/CONN-02/PAIR-03. Android (`core/protocol`), Apple (`HLProtocol`) và relay dùng làm nguồn đối chiếu trong test.
...
|------|-----------|-------|
| `common.schema.json` | Chỉ `$defs`: `uuid`, `uuid-v4` (`pair_id`), `uuid-v7` (`id`, `re`), `uuid-v8` (`device_id`), `int32`, `int64`, `timestamp`, `b64`, `b64u`, `b64u-32`, `ws-close-code` (mã đóng WebSocket) | 0.2, 0.3, 0.8.3 |

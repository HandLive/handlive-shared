...
- Tiếng Anh: viết hoa kiểu tiêu đề cho nút, mục menu, tiêu đề cửa sổ và sheet, tab, nhãn dòng cài đặt, tiêu đề alert và thông báo ("Send Clipboard to Phone", "Pair With {device_name}?"); viết hoa kiểu câu cho mô tả, chú thích, nội dung alert, nội dung thông báo, chuỗi trạng thái và tooltip ("Connected via Wi-Fi"). Ngắn, chủ động, thì hiện tại; không "please", "sorry", dấu chấm than hay emoji.

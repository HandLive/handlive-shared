...
POSITIVE = [
    ...
    ("POST /v1/push alert", "relay-rest#push-request",
     {"pair_id": PAIR_ID, "to": DEVICE_C, "kind": "alert", "reason": "sms_new", "env_b64": ENV_B64,
      "collapse_key": "sms:sms:12847", "ttl_s": 86400}),
    ...
    ("APNs SMS", "push#apns-payload",
     {"aps": {"alert": {"loc-key": "push.sms_new"}, "mutable-content": 1, "sound": "default", "thread-id": "sms:42",
...
NEGATIVE_SPECS = [
    ...
    ("push collapse_key over 64", "relay-rest#push-request", "POST /v1/push alert",
    ...
    ("APNs call in an SMS thread", "push#apns-payload", "APNs incoming call", _set(["aps", "thread-id"], "sms:42")),

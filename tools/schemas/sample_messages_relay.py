...
NEGATIVE_SPECS = [
    ...
    ("push ttl_s over 86,400", "relay-rest#push-request", "POST /v1/push wake with a collapse key",
     _set(["ttl_s"], 86401)),
    ("push ttl_s negative", "relay-rest#push-request", "POST /v1/push wake with a collapse key", _set(["ttl_s"], -1)),
    ("push incoming call living a minute", "relay-rest#push-request", "POST /v1/push incoming call",
     _set(["ttl_s"], 60)),
    ("push SMS living an hour", "relay-rest#push-request", "POST /v1/push alert", _set(["ttl_s"], 3600)),
    ("push missed call living 30 s", "relay-rest#push-request", "POST /v1/push missed call from the call log",
     _set(["ttl_s"], 30)),
